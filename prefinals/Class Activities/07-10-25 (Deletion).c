...
//apply deletion
bool deleteItem(NodePtr *list, int item); //delete first
bool deleteAllItem(NodePtr *list, int item); //deleteOccurence
void insertSorted(NodePtr *list, int item); //insert sorted in ASC order
NodePtr removeDuplicates(NodePtr *list, int item); //returns the deleted duplicates
